...
typedef struct Playing_Info {
    ...
    s_char spray_pow; // offset 0x9, size 0x1
    u_short savecount; // offset 0xA, size 0x2
    ...
    s_char screen_position_x; // offset 0x77, size 0x1
    s_char screen_position_y; // offset 0x78, size 0x1
