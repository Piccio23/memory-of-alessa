...
INCLUDE_ASM("asm/nonmatchings/Event/stage/building_f_00", func_01F6D6A0_building_f_00);

void func_01F6D960_building_f_00(void* arg) {
    shQzero(arg, 0xE8);
}

INCLUDE_ASM("asm/nonmatchings/Event/stage/building_f_00", func_01F6D970_building_f_00);
